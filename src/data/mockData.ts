...
const RAW_KPIS: Kpi[] = [
  {
    ...
    source: 'BCB',
    asof: '28 jun · 09:00',
    def: 'Tipo de cambio oficial, fijo en Bs 6,96 por el BCB desde nov-2011. El 28-jun es el ÚLTIMO día del régimen fijo: desde el lunes 29-jun el BCB adopta un tipo de cambio FLEXIBLE, con un TCO inicial de Bs 9,73 calculado a diario (promedio ponderado de las compras de la banca, publicado a las 20:00). El referencial de venta será el TCO + Bs 0,10.',
  },
  {
    id: 'usdbob_paralelo',
    ...
    deltaLabel: '−0,1%',
    sentiment: 'neg',
    // mercado informal: cayó desde picos ~19 Bs (2025) a ~9,9 (anclas dic-25 9,60 · jun-26 9,88)
    spark: [19.0, 15.5, 12.0, 10.4, 9.6, 9.63, 9.7, 9.85, 9.96, 9.92, 9.9, 9.88],
    source: 'paralelo (P2P) · informal',
    asof: '28 jun',
    def: 'Promedio de cotizaciones P2P (informal, no oficial). Bajó desde picos de ~Bs 19 en 2025; estable en ~9,88 al 28-jun. El tipo de cambio flexible que arranca el 29-jun (TCO 9,73) acerca el oficial al paralelo.',
    extra: { label: 'BRECHA', value: '+42,0%', tone: 'neg' },
  },
  {
    id: 'vrd',
    label: 'VRD · BCB',
    ...
    deltaLabel: '≈ 0',
    sentiment: 'neg',
    spark: [9.2, 9.25, 9.3, 9.35, 9.4, 9.5, 9.65, 9.8, 10.0, 9.96, 9.86, 9.93],
    source: 'BCB · VRD',
    asof: '28 jun',
    def: 'Valor Referencial del Dólar del BCB (días hábiles). Se estabilizó en ~Bs 9,93. Desde el 29-jun, con el régimen flexible, el referencial de venta pasa a ser el nuevo TCO + Bs 0,10.',
    extra: { label: 'BRECHA', value: '+42,7%', tone: 'neg' },
  },
  {
    id: 'brecha',
    ...
    spark: [173, 123, 72, 49, 38, 38.4, 39.4, 41.5, 43.1, 42.2, 42.1, 42.0],
    source: 'derivado · paralelo/oficial',
    asof: '28 jun',
    def: 'Brecha entre el dólar paralelo y el oficial (6,96). Al 28-jun ~42%. Con el tipo de cambio FLEXIBLE que arranca el 29-jun (TCO 9,73), la brecha contra el oficial colapsa de ~42% a ~2%: es, de facto, la unificación cambiaria.',
  },
  {
    id: 'brecha_vrd',
    label: 'BRECHA P/VRD',
    ...
    asof: '28 jun',
    def: 'Brecha entre el dólar paralelo y el VRD (el tipo de cambio de FACTO del BCB, no el oficial). Prácticamente cerrada: al 28-jun el paralelo (9,88) quedó algo por debajo del VRD (9,93). Con el régimen flexible (29-jun) el oficial converge a este nivel y la brecha relevante desaparece.',
  },
  {
    id: 'rin',
    label: 'RIN · BCB',
...
export const NOTICIAS: Noticia[] = [
  {
    id: 'n23', t: '−2h', mins: 120, fuente: 'El Diario', tag: 'Económico',
  ...
  {
    id: 'n24', t: '−4h', mins: 240, fuente: 'Erbol', tag: 'Político',
  ...
  {
    id: 'n25', t: '−2d', mins: 2430, fuente: 'Visión 360', tag: 'Económico',

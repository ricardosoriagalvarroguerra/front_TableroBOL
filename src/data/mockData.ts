...
const RAW_KPIS: Kpi[] = [
  ...
  },
  {
    ...
    deltaLabel: '−0,1%',
    sentiment: 'neg',
    // mercado informal: cayó desde picos ~19 Bs (2025) a ~9,9 (anclas dic-25 9,60 · jun-26 9,89)
    spark: [19.0, 15.5, 12.0, 10.4, 9.6, 9.63, 9.7, 9.85, 9.96, 9.93, 9.91, 9.89],
    source: 'paralelo (P2P) · informal',
    asof: '26 jun',
    def: 'Promedio de cotizaciones P2P (informal, no oficial). Bajó desde picos de ~Bs 19 en 2025; estable en ~9,89 al 26-jun tras el fin de los bloqueos. Brecha ~42% con el oficial.',
    extra: { label: 'BRECHA', value: '+42,1%', tone: 'neg' },
  },
  {
    id: 'vrd',
    label: 'VRD · BCB',
    ...
    source: 'BCB · VRD',
    asof: '26 jun',
    def: 'Valor Referencial del Dólar del BCB, publicado a diario desde dic-2025. Tocó un récord >Bs 10 a mediados de jun y se estabilizó en torno a Bs 9,9 (referencial 9,93 al 26-jun), por debajo de Bs 10.',
  ...
  },
  {
    ...
    spark: [173, 123, 72, 49, 38, 38.4, 39.4, 41.5, 43.1, 42.5, 42.2, 42.1],
    source: 'derivado · paralelo/oficial',
    asof: '26 jun',
    def: 'Brecha entre el dólar paralelo y el oficial (6,96). Se redujo desde picos de ~170% en 2025 a ~42% (26-jun).',
  },
  {
    id: 'brecha_vrd',
    label: 'BRECHA P/VRD',
    ...
    asof: '26 jun',
    def: 'Brecha entre el dólar paralelo y el VRD (el tipo de cambio de FACTO del BCB, no el oficial). Prácticamente cerrada: al 26-jun el paralelo (9,89) quedó algo por debajo del VRD (9,93), señal de que ya convergieron. La brecha grande (~42%) es solo contra el oficial administrado de 6,96, al que casi nadie accede.',
  },
  {
    id: 'rin',
    label: 'RIN · BCB',
...
export const NOTICIAS: Noticia[] = [
  {
    id: 'n20', t: '−2h', mins: 120, fuente: 'El Diario', tag: 'Social',
  ...
  {
    id: 'n21', t: '−16h', mins: 960, fuente: 'El Deber', tag: 'Económico',
  ...
  {
    id: 'n22', t: '−18h', mins: 1050, fuente: 'La Patria', tag: 'Económico',
  ...
  {
    id: 'n14', t: '−2d', mins: 2890, fuente: 'Infobae', tag: 'Político',
  ...
  {
    id: 'n15', t: '−2d', mins: 2970, fuente: 'Red Uno', tag: 'Económico',
  ...
  {
    id: 'n17', t: '−3d', mins: 3916, fuente: 'Infobae', tag: 'Político',
  ...
  {
    id: 'n18', t: '−3d', mins: 4140, fuente: 'Infobae', tag: 'Político',
  ...
  {
    id: 'n16', t: '−3d', mins: 4364, fuente: 'Opinión', tag: 'Social',
  ...
  {
    id: 'n19', t: '−3d', mins: 4560, fuente: 'La Patria', tag: 'Social',
